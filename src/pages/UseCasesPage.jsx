              ...
              <div className="grid-2" style={{ alignItems: 'center' }}>
                <div>
                  ...
                  <p style={{ marginTop: '0.75rem', marginBottom: '1.25rem' }}>
                    Engineers queue up pre-sliced G-code files before leaving at 5 PM. Dasher 1 nodes print overnight, automatically swap completed plates into the storage rack, and reset. Engineers arrive at 8 AM to find 3 consecutive iterations ready for inspection.
                  </p>
            ...
            <div className="case-study-card">
              <div className="grid-2" style={{ alignItems: 'center' }}>
                <div className="quote-callout-box" style={{ order: 2 }}>
                  ...
                  <p style={{ fontSize: '0.9rem', marginTop: '0.5rem', color: 'var(--text-muted)' }}>
                    "Managing 400 engineering students' G-code files used to require 3 full-time lab TAs. Now students upload via the cloud portal, and the Dashing array handles queuing, printing, and plate swapping automatically."
                  </p>
                  <div style={{ marginTop: '1rem', fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>
