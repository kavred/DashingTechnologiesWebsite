              ...
              <div className="grid-2" style={{ alignItems: 'center' }}>
                <div>
                  ...
                  <p style={{ marginTop: '0.75rem', marginBottom: '1.25rem' }}>
                    Engineers submit pre-sliced G-code jobs before leaving at 5 PM. Dashing nodes print overnight, flex-eject completed parts into bin trays, and reset automatically. Engineers arrive at 8 AM to find 3 consecutive iterations ready for inspection.
                  </p>
            ...
            <div className="case-study-card">
              <div className="grid-2" style={{ alignItems: 'center' }}>
                <div className="quote-callout-box" style={{ order: 2 }}>
                  ...
                  <p style={{ fontSize: '0.9rem', marginTop: '0.5rem', color: 'var(--text-muted)' }}>
                    "Managing 400 engineering students' print queues used to require 3 full-time lab TAs. Now students upload G-code via the cloud portal, and the Dashing array handles automatic dispatching, printing, and part ejection."
                  </p>
                  <div style={{ marginTop: '1rem', fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>
